...
| TASK-018 | Skill 作用域(项目/用户) + Skill 商店(GitHub 源) | claude-20260803-01 | DONE   | master (TASK-018 commit)           | skills/skill-store/config/paths/application/server/cli-program/web/api/tests + DOCS(D-003 更新)   | 用户批准的三项设计决策(分离存储/可配置列表/顶级页) | 2026-08-04 18:25 +0800 |
